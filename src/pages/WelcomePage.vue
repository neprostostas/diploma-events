  ...
  <div class="welcome-page-wrapper bg-dark h-100 overflow-hidden"
    ...
    <div id="welcome-screen" class="welcome-screen inner-padd" :class="welcomeScreen ? 'animated' : ''">
      <div class="logo-wrapper">
        <div class="logo logo-big"><img src="@/assets/img/logo/logo-white.svg" alt="diploma-events"></div>
      </div>
    ...
    <div v-if="welcome_1" class="welcome_container" v-touch:swipe.left="swipeScreen('2')">
      <div id="intro-page">
        ...
        <h3 class="text text-big">Find your perfect spot</h3>
        <p class="text text-small">Explore interactive map to find activities happening throughout your selected city and pick the best for <strong>YOU</strong>.
        </p>
    ...
    <div v-if="welcome_2" class="welcome_container" v-touch:swipe.left="swipeScreen('3')"
      ...
      <div id="intro-page">
        ...
        <h3 class="text text-big">Connect with your tribe</h3>
        <p class="text text-small">Take control! Engage with event organizers at your favourite locations and secure your spot on the guest list.</p>
    ...
    <div v-if="welcome_3" class="welcome_container" v-touch:swipe.right="swipeScreen('2')">
      <div id="intro-page">
        ...
        <h3 class="text text-big">Create your own experiences</h3>
        <p class="text text-small">Ready to make things happen? Transition from soaking up vibes to crafting your own! Join as a promoter and gain access to all the tools you need to host your own events or manage your own sections.</p>
